...
<div class="desc">
  ...
  <b>AI-автоматизация</b> — AI-агенты и LLM, снимающие рутину при работе с данными. &nbsp;•&nbsp;
  <b>AI-assisted разработка</b> — внутренние инструменты в связке с ИИ, полный цикл от идеи до деплоя.
</div>

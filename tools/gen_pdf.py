...
<div class="desc">
  ...
  <b>Агентная разработка (agentic engineering)</b> — цель и ограничения ставлю я, ИИ-агенты (Claude Code, Codex) итерируют, в цикле тесты и проверка на стенде; так собрал плагин AgentTIM для Revit (C#, 2020–2027) и ферму на нём, сервис аудита смет (Python/FastAPI) со встройкой в Меркурий, инфобот по объёмам объектов, модули Меркурия (React/.NET); полный цикл от идеи до деплоя.
</div>
...
<div class="tags">
  ...
  <span class="tag">Агентная разработка</span><span class="tag">C# / Revit API</span><span class="tag">Python</span><span class="tag">MCP-серверы</span><span class="tag">N8N</span><span class="tag">EIR разработка</span>
